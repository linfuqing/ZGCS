...
namespace ZG
{
    ...
    public class DepthOfField : MonoBehaviour
    {
        ...
        void OnEnable()
        {
            ...
            __camera.depthTextureMode |= DepthTextureMode.Depth;
        }
        ...
        void OnRenderImage(RenderTexture source, RenderTexture destination)
        {
            if (material)
            {
                ...
                Mathf.Clamp(focalDistance, __camera.nearClipPlane, __camera.farClipPlane);
        ...
        {
            return __camera.WorldToViewportPoint((distance - __camera.nearClipPlane) * __camera.transform.forward + __camera.transform.position).z / (__camera.farClipPlane - __camera.nearClipPlane);
        }
    }
}